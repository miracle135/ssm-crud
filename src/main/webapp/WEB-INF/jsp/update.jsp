...
<body>
	<div class="container">
	<h3 class="text-center">${username}你好，请修改学生信息</h3>
		<form action="/ssm-crud/student/updateStudentTwo" method="post" id="reg">
			<div class="form-group">
				<label for="sid">学号</label> <input type="text" class="form-control"
					id="sid" placeholder="学号" name="sid" readonly="readonly" value="${sid}">
			</div>
			<div class="form-group">
